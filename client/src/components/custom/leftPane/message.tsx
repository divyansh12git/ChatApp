...
function Messages () {
    return (
            <div className="bg-[#1c1c24] w-full col-span-7 flex flex-col items-center overflow-y-scroll overflow-x-hidden">
            ...
            <ProfileCard key={1} profilepic={profilepic2} username="Selena" message="hi there" count={1} />
